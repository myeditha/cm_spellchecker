...
def spellcheckEntry():
	...
	parser.add_argument('-dictDoc',default = None, type=str,help='dictionary of words in language denoted by -langTag.')
	...
	spellchecker = Spellchecker(args.langTag, args.repklEng, args.A, args.outputType, args.tagDoc, args.dictDoc)
